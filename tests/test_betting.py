...
class BettingInit(unittest.TestCase):
    ...
    def test_base_endpoint_init(self):
        ...
        assert betting._error is None
        assert betting.client == client
        assert betting.URI == 'betting/rest/v1.0/'
        assert betting.METHOD is None
...
class BettingTest(unittest.TestCase):
    ...
    def test_list_event_types(self, mock_response):
        ...
        mock_response.return_value = (mock.json().get('result'), 1.3)

        response = self.betting.list_event_types()
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listEventTypes', {'filter': {}}, None)
    ...
    def test_list_competitions(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listCompetitions', {'filter': {}}, None)
    ...
    def test_list_time_ranges(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listTimeRanges', {'granularity': 'DAYS', 'filter': {}}, None)
    ...
    def test_list_events(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listEvents', {'filter': {}}, None)
    ...
    def test_list_market_types(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listMarketTypes', {'filter': {}}, None)
    ...
    def test_list_countries(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listCountries', {'filter': {}}, None)
    ...
    def test_list_venues(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listVenues', {'filter': {}}, None)
    ...
    def test_list_market_catalogue(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listMarketCatalogue', {'maxResults': 1, 'filter': {}}, None)
    ...
    def test_list_market_book(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listMarketBook', {'marketIds': marketIds}, None)
    ...
    def test_list_current_orders(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listCurrentOrders', {'dateRange': {'from': None, 'to': None}}, None)
    ...
    def test_list_cleared_orders(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('listClearedOrders', {'settledDateRange': {'to': None, 'from': None}, 'betStatus': 'SETTLED'}, None)
    ...
    def test_place_orders(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('placeOrders', {'marketId': marketId, 'instructions': instructions}, None)
    ...
    def test_cancel_orders(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('cancelOrders', {'marketId': marketId, 'instructions': instructions}, None)
    ...
    def test_update_orders(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('updateOrders', {'marketId': marketId, 'instructions': instructions}, None)
    ...
    def test_replace_orders(self, mock_response):
        ...
        assert mock.json.call_count == 1
        mock_response.assert_called_with('replaceOrders', {'marketId': marketId, 'instructions': instructions}, None)
